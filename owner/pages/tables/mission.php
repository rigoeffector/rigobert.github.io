<?php
  ...
  //   $phone = $_POST['phone'];
			...
			$stmt = $DB_con->prepare('INSERT INTO mission(mission) VALUES(:reason)');
			$stmt->bindParam(':reason',$reason);

			if($stmt->execute())
			{
				$successMSG = "new mission succesfully added ...";
 ...
 <?php if (isset($_SESSION['usr_id'])) { ?>
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Drimex Missions</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
  ...
  <!-- <a href="chooseusreasons.php" class="btn btn-success">See all Reasons to choose us </a> -->
                  <form method="post" enctype="multipart/form-data" class="form-horizontal">
                      ...
                      <tr>
                      	<td><label class="control-label">Missions.</label></td>
                          <td><input class="form-control" required type="text" name="reason" placeholder="Enter drimex mission"  /></td>
                      </tr>
                ...
                <hr>
                <div class="box-body">
                  <h2 align="center">All Missions</h2>
          ...
          include "connects.php";
           ...
           $result=mysqli_query($conn,"SELECT * from mission order by ID asc");
           ...
           while($test = mysqli_fetch_array($result))
           {
             ...
             ?><td colspan="2"><a href="../../upload/editmission.php?edit_id=<?php echo $test['ID']; ?>" title="click for edit" onclick="return confirm('sure to edit ?')" class='btn btn-success'>Update</a>

<a href="missiondelete.php?delete_id=<?php echo $test['ID']; ?>" title="click for delete" onclick="return confirm('sure to delete ?')" class='btn btn-danger'>Delete</a></td>
