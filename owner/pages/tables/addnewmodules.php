<?php
    ...
    $levels =$_POST['levels'];
		...
		// if no error occured, continue ....
			...
			$stmt = $DB_con->prepare('INSERT INTO modules(Name,lecturer,department,levels) VALUES(:uname, :ulecturer, :udepartment, :ulevels)');
			$stmt->bindParam(':uname',$username);
			$stmt->bindParam(':ulecturer',$lecturer);
			$stmt->bindParam(':udepartment',$department);
      $stmt->bindParam(':ulevels',$levels);

			if($stmt->execute())
			{
				$successMSG = "new module has  succesfully inserted ...";
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  	...
                  	?>
  <a href="modules.php" class="btn btn-success">See all modules</a>
                  <form method="post" enctype="multipart/form-data" class="form-horizontal">

                  	<table class="table table-bordered table-responsive">

                      <tr>
                        <td><label class="control-label">module name.</label></td>
          ...
          ?>
                  		...
                  		<tr>
                  		<td>	<label for="sel1">Select department and level:</label></td>
                  			<td>	
