<?php
  ...
  //   $phone = $_POST['phone'];
			...
			$stmt = $DB_con->prepare('INSERT INTO aim(aim) VALUES(:reason)');
			$stmt->bindParam(':reason',$reason);

			if($stmt->execute())
			{
				$successMSG = "new aim succesfully added ...";
 ...
 <?php if (isset($_SESSION['usr_id'])) { ?>
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Drimex aims</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
  ...
  <!-- <a href="chooseusreasons.php" class="btn btn-success">See all Reasons to choose us </a> -->
                  <form method="post" enctype="multipart/form-data" class="form-horizontal">
                      ...
                      <tr>
                      	<td><label class="control-label">aims.</label></td>
                          <td><input class="form-control" required type="text" name="reason" placeholder="Enter drimex aim"  /></td>
                      </tr>
