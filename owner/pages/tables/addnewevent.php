<?php
    ...
    $phone = $_POST['phone'];
		...
		$imgSize = $_FILES['user_image']['size'];
			...
			$upload_dir = '../../../eventimages/'; // upload directory
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('INSERT INTO event(title,sdescription,description,Pic,dateadded) VALUES(:title, :sdescription, :description, :upic,now())');
      ...
      $stmt->bindParam(':description',$phone);
			...
			if($stmt->execute())
			{
				$successMSG = "new event succesfully inserted ...";
  ...
  <a href="events.php" class="btn btn-success">See all Event </a>
                  <form method="post" enctype="multipart/form-data" class="form-horizontal">
                      ...
                      <tr>
                          ...
                          <td><input class="form-control" required type="text" name="user_name" placeholder="Enter Event Title" value="<?php echo $username; ?>" /></td>
                      </tr>

                      <tr>
                        <td><label class="control-label">Event short description with 100 characters</label></td>
                          <td><textarea class="form-control"  style="height: 70px" required type="text" name="user_job" placeholder="Event  short description"></textarea></td>
                      </tr>


                      <tr>
                        <td><label class="control-label"> Event description</label></td>
                          <td><textarea class="form-control" type="text" name="phone" placeholder="Event  description" required="" style="height: 140px"><pre style="font-size: 20px;
