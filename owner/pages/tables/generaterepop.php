...
include "connect.php";
 ...
 <a class="btn btn-success"  onclick="printDiv('printMe')">Generate Report</a><br/><br/>
  <div id="printMe">
    ...
    <h3 align="center">You have <?php
       include '../../conn.php';
       $district = $_POST['district'];

      $count = mysqli_fetch_array(mysqli_query($con, "SELECT COUNT(*) FROM crime WHERE address1='$district'"));

echo $count[0];
       //echo 50; ?> Crime in <?php echo $district;  ?> District</h3>
 ...
 -->
           ...
           $result=mysqli_query($conn,"SELECT * from crime WHERE address1='$district'");
