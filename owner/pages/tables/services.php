        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="box-body">
                   ...
                   <a class="btn btn-success" href="addnewservice.php">add new service </a><br/><br/>
           ...
           while($test = mysqli_fetch_array($result))
           {
             ...
             ?><td><a href="../../upload/editservice.php?edit_id=<?php echo $test['ID']; ?>" title="click for edit" onclick="return confirm('sure to edit ?')" class='btn btn-success'>Update</a></td>


             <td><a href="servicedelete.php?delete_id=<?php echo $test['ID']; ?>" title="click for delete" onclick="return confirm('sure to delete ?')" class='btn btn-danger'>Delete</a></td>
             <td>	<img src="../../../services/<?php echo $test['Pic']; ?>" style="height: 60px">
               </td>
