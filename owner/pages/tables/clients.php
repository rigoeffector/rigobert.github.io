          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <a class="btn btn-success" href="addnewclient.php">Add new client</a><br/><br/>
           ...
           while($test = mysqli_fetch_array($result))
           {
             ...
             echo "<tr align=''>";
              ...
              echo"<td>" .$test['client_title']."</font></td>";
            ...
            // echo"<td>" .$test['email']."</font></td>";
             ...
             ?><td><a href="../../upload/editclient.php?edit_id=<?php echo $test['client_id']; ?>" title="click for edit" onclick="return confirm('sure to edit ?')" class='btn btn-success'>Update</a></td>


             <td><a href="deleteclient.php?delete_id=<?php echo $test['client_id']; ?>" title="click for delete" onclick="return confirm('sure to delete ?')" class='btn btn-danger'>Delete</a></td>
             <td>	<img src="../../../html/clientimage/<?php echo $test['client_image']; ?>" style="height: 60px">
               </td>
