        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="box-body">
                   ...
                   <a class="btn btn-success" href="addnewevent.php">add new event </a><br/><br/>
           ...
           while($test = mysqli_fetch_array($result))
           {
             ...
             ?><td><a href="../../upload/editevent.php?edit_id=<?php echo $test['ID']; ?>" title="click for edit" onclick="return confirm('sure to edit ?')" class='btn btn-success'>Update</a></td>
             ...
             <td>	<img src="../../../eventimages/<?php echo $test['Pic']; ?>" style="height: 60px">
               </td>
