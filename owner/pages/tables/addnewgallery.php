...
include "connect.php";
    ...
    $caption = $_POST['caption'];
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('INSERT INTO gallery(caption,Pic) VALUES(:cap, :upic)');
      $stmt->bindParam(':cap',$caption);
			$stmt->bindParam(':upic',$userpic);

			if($stmt->execute())
			{
				$successMSG = "new photo succesfully added ...";
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  	...
                  	?>
  <a href="gallery.php" class="btn btn-success">See all photos</a>
                  ...
                  <form method="post" enctype="multipart/form-data" class="form-horizontal">
                      ...
                      <tr>
                        <td><label class="control-label">Caption</label></td>
                          <td><input class="form-control" type="text" name="caption" placeholder="Enter the name of the user"  /></td>
                      </tr>
