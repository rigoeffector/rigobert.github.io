<?php
    ...
    $district = $_POST['district'];
		...
		$imgSize = $_FILES['user_image']['size'];
			...
			$upload_dir = '../../../articles/'; // upload directory
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('INSERT INTO updates(title,sdescription,description,Pic,district,cap,dateadded) VALUES(:title, :sdescription, :description, :upic, :district, :cap,now())');
      ...
      $stmt->bindParam(':district',$district);
			...
			if($stmt->execute())
			{
				$successMSG = "new Drimex Updates succesfully added ...";
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Drimex Updates</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  	...
                  	?>
  <a href="drimexupdates.php" class="btn btn-success">See all Drimex Updates </a>
                  <form method="post" enctype="multipart/form-data" class="form-horizontal">
                      ...
                      <tr>
                        <td><label class="control-label">Drimex Updates Title.</label></td>
                          <td><input class="form-control" required type="text" name="title" placeholder="Enter Drimex news Title" value="<?php echo $username; ?>" /></td>
                      </tr>

                      <tr>
                        <td><label class="control-label">Drimex updates short description with 100 characters</label></td>
                          <td><textarea class="form-control"  style="height: 70px" required type="text" name="description" placeholder="Drimex news  short description"></textarea></td>
                      </tr>


                      <tr>
                        <td><label class="control-label">Drimex news  and events description</label></td>
                          <td><textarea class="form-control" type="text" name="full" placeholder="Drimex news  description" required="" style="height: 140px" style="font-size: 20px;
    font-family: "Times New Roman", Times, serif;color:grey">
                      ...
                      <tr>
                      	<td><label class="control-label">Drimex NEWS  and events Img.</label></td>
