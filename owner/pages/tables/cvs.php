        ...
        <section class="content">
          <div class="row">
           ...
           while($test = mysqli_fetch_array($result))
           {
             ...
             echo"<td>" .$test['mname']."</font></td>";
             echo"<td>" .$test['email']."</font></td>";
              echo"<td>" .$test['age']."</font></td>";
               echo"<td>" .$test['address']."</font></td>";
                echo"<td>" .$test['phone']."</font></td>";



             ?>
             <td><a class="btn btn-success" href="../../../html/files/<?php echo $test['Pic'] ?>" target="_blank">View</a>	
               </td>
