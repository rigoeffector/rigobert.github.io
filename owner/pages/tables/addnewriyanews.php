<?php
    ...
    $phone = $_POST['phone'];
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('INSERT INTO riyanews(title,sdescription,description,Pic,dateadded) VALUES(:title, :sdescription, :description, :upic,now())');
      ...
      $stmt->bindParam(':description',$phone);
			...
			if($stmt->execute())
			{
				$successMSG = "new news uccesfully inserted ...";
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Riya news</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  	...
                  	?>
  <a href="riyanews.php" class="btn btn-success">See all RIYA news </a>
                  <form method="post" enctype="multipart/form-data" class="form-horizontal">

                  	<table class="table table-bordered table-responsive">

                      <tr>
                      	<td><label class="control-label">RIYA news Title.</label></td>
                      ...
                      <tr>
                        <td><label class="control-label">RIYA news short description with 100 characters</label></td>
                      ...
                      <tr>
                        <td><label class="control-label">RIYA news description</label></td>
    ...
    font-family: "Times New Roman", Times, serif;color:grey">     
                      ...
                      <tr>
                      	<td><label class="control-label">RIYA NEWS Img.</label></td>
