...
<br/><br/>
 <select style='width:200px;height:40px' id="sel1" name="date">
...
<?php
 ...
 <table id="example1" class="table table-bordered " style="background-color: white">
           ...
           while($test = mysqli_fetch_array($result))
           {
             ...
             ?>
<td>
  <form method="post" action="transprint.php">
  <input type="hidden" value="<?php echo $test['regno']; ?>" name="regno">
  <input type="hidden" value="<?php echo $test['academicyear']; ?>" name="year">
<input type="submit" name="trans" value="Transcript" class="btn btn-success">
</form></td>
           <!--   <td><a href="../../upload/transcript.php?edit_id=<?php //echo $test['ID']; ?>" title="click for edit" onclick="return confirm('sure to edit ?')" class='btn btn-success'>Transcript</a></td> -->
