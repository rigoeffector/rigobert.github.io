      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
           ...
           {
             $id = $test['department_id'];
             //echo "<tbody>";
             echo "<tr align=''>";
              echo"<td>" .$test['department_id']."</font></td>";
            ...
            // echo"<td>" .$test['levels']."</font></td>";
             ?><td><a href="../../upload/editdepartment.php?edit_id=<?php echo $test['department_id']; ?>" title="click for edit" onclick="return confirm('sure to edit ?')" class='btn btn-success'>Update</a></td>


             <td><a href="?delete_id=<?php echo $test['department_id']; ?>" title="click for delete" onclick="return confirm('sure to delete ?')" class='btn btn-danger'>Delete</a></td>
           ...
           ?>
                  ...
                  <?php
                  	...
                  	if(isset($_GET['delete_id']))
                  	{
                  		...
                  		$stmt_delete = $DB_con->prepare('DELETE FROM department WHERE department_id =:uid');
