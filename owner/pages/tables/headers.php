...
<!--   <li class="treeview">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="./addnewcoordinator.php"><i class="fa fa-circle-o"></i>Add new District Coordinator</a></li>
          <li><a href="./coordinators.php"><i class="fa fa-circle-o"></i>All District Coordinators</a></li>
        </ul>
      </li>
...
<?php } else { ?>
<a href="../Secretary/index.php"><img src="images/login.jpg" alt=""></a>
<?php } ?>
<?php ob_end_flush(); ?>