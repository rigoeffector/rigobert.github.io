...
<?php
  ...
  if(isset($_POST['send'])){
   // $module = $_POST['module'];
      ...
      echo "<h2><b>This is the marks of remedial  class ".$levels. "</b></h2>";

    ?>
<a class="btn btn-success"  onclick="window.print()">Generate Report</a>
