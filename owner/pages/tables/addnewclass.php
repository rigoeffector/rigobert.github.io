<?php
    ...
    $levels =$_POST['levels'];
		...
		// if no error occured, continue ....
			...
			$stmt = $DB_con->prepare('INSERT INTO levels(levels_name,department_id) VALUES(:uname, :ulecturer)');
			$stmt->bindParam(':uname',$username);
			$stmt->bindParam(':ulecturer',$lecturer);
			if($stmt->execute())
			{
				$successMSG = "new class has  succesfully inserted ...";
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  	...
                  	?>
  <a href="classes.php" class="btn btn-success">See all classes</a>
                  <form method="post" enctype="multipart/form-data" class="form-horizontal">

                  	<table class="table table-bordered table-responsive">

                      <tr>
                        <td><label class="control-label">class name.</label></td>
          ...
          or die ('Cannot connect to db');
           ...
           echo "<select name='lecturer' class='form-control' ><option>---select department---</option>";
