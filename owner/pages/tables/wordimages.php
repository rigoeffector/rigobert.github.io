          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <a class="btn btn-success" href="addnewimages.php">Add new testimonial</a><br/><br/>
          ...
          include "connects.php";
           ...
           while($test = mysqli_fetch_array($result))
           {
            ...
            echo"<td>" .$test['district']."</font></td>";
             ...
             ?>
               <td> <img src="../../../testimonials/<?php echo $test['user_image']; ?>" style="height: 40px">
               </td>
