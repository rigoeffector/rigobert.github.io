          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <a class="btn btn-success" href="addnewads.php">Add new ADS</a><br/><br/>
           ...
           while($test = mysqli_fetch_array($result))
           {
             ...
             echo "<tr align=''>";
              ...
              echo"<td>" .$test['ads_title']."</font></td>";
            ...
            // echo"<td>" .$test['email']."</font></td>";
             ...
             ?><td><a href="../../upload/editads.php?edit_id=<?php echo $test['ads_id']; ?>" title="click for edit" onclick="return confirm('sure to edit ?')" class='btn btn-success'>Update</a></td>


             <td><a href="deleteads.php?delete_id=<?php echo $test['ads_id']; ?>" title="click for delete" onclick="return confirm('sure to delete ?')" class='btn btn-danger'>Delete</a></td>
             <td>	<img src="../../../html/adsimage/<?php echo $test['ads_image']; ?>" style="height: 60px">
               </td>
