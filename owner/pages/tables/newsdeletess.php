  ...
  try{
    ...
    echo $e->getMessage();
                    ...
                    if(isset($_GET['delete_id']))
                    {
                      ...
                      $stmt_delete = $DB_con->prepare('UPDATE riyanews SET Pico = NULL,caption =NULL WHERE ID =:uid');
                    ...
                    if(isset($_GET['delete_idd']))
                    {
                      ...
                      // it will delete an actual record from db
                      $stmt_delete = $DB_con->prepare('UPDATE riyanewsenglish SET Pico = NULL,caption =NULL WHERE ID =:uid');
