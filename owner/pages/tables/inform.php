        ...
        <section class="content">
          ...
          include "connects.php";
           ...
           while($test = mysqli_fetch_array($result))
           {
            ...
            echo"<td><a href='mailto:".$test['email']."?Subject=Hello%20again' target='_top'>" .$test['email']."</a></td>";
...
//     } ?>
          <!--   <a class="btn btn-success" href='mailto:<?php //echo $row[4].";" ?>?Subject=Hello%20again' target='_top'>Notify</a> -->
