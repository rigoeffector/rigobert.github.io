      ...
      <li class=" treeview">
       ...
       <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="./addreport.php"><i class="fa fa-circle-o"></i>Add new Report</a></li>
          <li><a href="./reportss.php"><i class="fa fa-circle-o"></i>Your Reports</a></li>
        </ul>
      </li>
 <!--  <li class="treeview">
        <a href="#">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="./addnewmember.php"><i class="fa fa-circle-o"></i>Add new Member</a></li>
          <li><a href="./members.php"><i class="fa fa-circle-o"></i>All Members</a></li>
        </ul>
      </li>
