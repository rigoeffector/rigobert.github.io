...
$password = md5(123456);
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('INSERT INTO users(name,phone,email,user_image,password,type,district) VALUES(:uname, :uphone, :uemail, :upic, :password, :type,:district)');
      ...
      $stmt->bindParam(':type',$type);
			...
			if($stmt->execute())
			{
				$successMSG = "new District Coordinator succesfully added ...";
 ...
 <?php if (isset($_SESSION['usr_id'])) { ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
          RVC App new District Coordinator
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">new District Coordinator</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  	...
                  	?>
  <a href="coordinators.php" class="btn btn-success">See all District Coordinator</a>
                  ...
                  <form method="post" enctype="multipart/form-data" class="form-horizontal">
                      ...
                      <tr>
                        <td><label class="control-label">Name.</label></td>
                          <td><input class="form-control" type="text" name="name" placeholder="Enter the name of the Coordinator name" value="<?php echo $username; ?>" /></td>
                      </tr>

                       <tr>
                        <td><label class="control-label">Phone number.</label></td>
                          <td><input class="form-control" type="number" name="phone" placeholder="Enter District Coordinator phone number" value="<?php echo $Coordinator; ?>" /></td>
                      </tr>

                         <tr>
                        <td><label class="control-label">Email.</label></td>
                          <td><input class="form-control" type="email" name="email" placeholder="Enter District Coordinator email" value="<?php echo $Coordinator; ?>" /></td>
                      </tr>

                     <!--  <tr>
                        <td><label class="control-label">District.</label></td>
                          <td>
                             <select value="<?php //echo $District Coordinator; ?>" class="form-control" id="sel1" name="district">
        <option>1</option>
        <option>2</option>
        <option>3</option>
        <option>4</option>
