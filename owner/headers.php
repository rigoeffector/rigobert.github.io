...
<header class="main-header">
  <!-- Logo -->
  <a href="indexs.php" class="logo"><b>RVC</b> Secretary</a>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <img src="dist/img/sec.png" class="user-image" alt="User Image"/>
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-header">
              <img src="dist/img/sec.png" class="img-circle" alt="User Image" />
              <p>
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class=" treeview">
       ...
       <li class=" treeview">
        <a href="./pages/tables/generaterepo.php">
...
<li class="treeview">
      ...
      <li class="treeview">
        <a href="#">
          <i class="fa fa-users"></i> <span>District Coordinators</span>
          <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
          <li><a href="./pages/tables/addnewcoordinator.php"><i class="fa fa-circle-o"></i>Add new District Coordinator</a></li>
          <li><a href="./pages/tables/coordinators.php"><i class="fa fa-circle-o"></i>All District Coordinators</a></li>
          <!--  <li><a href="./pages/tables/wordnoimages.php"><i class="fa fa-circle-o"></i> Words with no images</a></li>  -->
        </ul>
      </li>
