            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">RVC Coordinators</span>
                  <span class="info-box-number">
                    <?php
        include 'conn.php';
   
       $count = mysqli_fetch_array(mysqli_query($con, "SELECT COUNT(*) FROM users where type='coordinator'"));
        ...
        //echo 50; ?></span>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">RVC Reports</span>
                  <span class="info-box-number">
                     <?php
         include 'conn.php';
    
       $count = mysqli_fetch_array(mysqli_query($con, "SELECT COUNT(*) FROM reports"));
...
<div class="row">
          ...
          include "./pages/tables/connects.php";
           ...
           while($test = mysqli_fetch_array($result))
           {
            ...
            echo"<td><span class='label label-warning'>" .$test['phone']."</span></td>";
            ...
            // echo"<td>" .$test['dateadded']."</font></td>";
             ...
             ?>
                    ...
                    <td ><img style="width: 100px" src="../coordinator/<?php echo $test['user_image'] ?>"></td>
