...
<header class="main-header">
  <!-- Logo -->
  <a href="index.php" class="logo"><b>RVC</b> Admin</a>
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class=" treeview">
       ...
       <li class=" treeview">
        <a href="./pages/tables/reportsall.php">
       ...
       <li class=" treeview">
        <a href="./pages/tables/cordinatorsall.php">
          <i class="fa fa-users"></i> <span>Coordinators</span>
        </a>
