...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">Update Drimex updates details. <a class="btn btn-success" href="../pages/tables/updates.php"> all Drimex updates </a>
...
<tr>
        ...
        <td><input required class="form-control" placeholder="Caption" type="text" name="user_jobs"  required /></td>
    </tr>
<tr>
