<?php
	...
	{
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare('SELECT * FROM news WHERE ID =:uid');
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if(!isset($errMSG))
		{
			...
			if($stmt->execute()){
				...
				window.location.href='../pages/tables/updates.php';
				</script>
                <?php
			}
			else{
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
     ...
     <tr>
        ...
        <td><textarea class="form-control" type="text" name="user_job1" value="" ><?php echo $edit_row['description']; ?></textarea>
        	</td>
    </tr>
...
<tr>
	<td><label class="control-label"> Img.</label></td>
		<td>
			<p><img src="../../images/<?php echo $edit_row['Pic']; ?>" height="150" width="150" /></p>
