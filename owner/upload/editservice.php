<?php
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE services
									     SET title=:title,
										     sdescription=:short,
										     Pic=:upic
								       WHERE ID=:uid');
			...
			if($stmt->execute()){
				...
				window.location.href='../pages/tables/services.php';
				</script>
                <?php
			}
			else{
...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">Update services details. <a class="btn btn-success" href="../pages/tables/services.php"> all Drimex services </a>
...
<tr>
	<td><label class="control-label"> Img.</label></td>
		<td>
			<p><img src="../../services/<?php echo $edit_row['Pic']; ?>" height="150" width="150" /></p>
