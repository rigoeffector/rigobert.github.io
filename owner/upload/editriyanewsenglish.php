...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">Update RIYA news and events  details. <a class="btn btn-success" href="../pages/tables/riyanewsenglish.php"> all RIYA news and events </a>
   ...
   <tr>
    ...
    <tr>
     ...
     <tr>
        ...
        <td><textarea class="form-control" type="text" name="user_job1" rows="5"><pre><?php echo $edit_row['description']; ?>
