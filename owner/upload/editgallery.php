<?php
	...
	{
		header("Location: ../pages/tables/gallery.php");
	}
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		//$testimonial = $_POST['testimonial'];// user email
		...
		if(!isset($errMSG))
		{
			...
			if($stmt->execute()){
				...
				window.location.href='../pages/tables/gallery.php';
				</script>
                <?php
			}
			else{
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
        ...
        <td><input class="form-control" type="text" name="user_name" value="<?php echo $edit_row['caption']; ?>" required /></td>
    </tr>
...
<tr>
	<td><label class="control-label"> Img.</label></td>
		<td>
			<p><img src="../../gallery/<?php echo $edit_row['Pic']; ?>" height="150" width="150" /></p>
