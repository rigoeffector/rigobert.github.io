<?php
	...
	{
		header("Location: ../pages/tables/drimexupdates.php");
	}
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE updates
									     SET title=:title,
										     sdescription=:short,
										     description=:details,
										     Pic=:upic
			...
			if($stmt->execute()){
				...
				window.location.href='../pages/tables/drimexupdates.php';
				</script>
                <?php
			}
			else{
...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">Update Drimex updates. <a class="btn btn-success" href="../pages/tables/drimexupdates.php"> all Drimex updates</a>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
   ...
   <tr>
    ...
    <tr>
        ...
        <td><textarea class="form-control" type="text" name="user_job" required ><?php echo $edit_row['sdescription']; ?></textarea>
        </td>
    </tr>
    
     <tr>
    	<td><label class="control-label">Description.</label></td>
        <td><textarea class="form-control" type="text" name="user_job1" rows="5"><?php echo $edit_row['description']; ?>
</textarea>
        	</td>
    </tr>
...
<tr>
	<td><label class="control-label"> Img.</label></td>
		<td>
			<p><img src="../../articles/<?php echo $edit_row['Pic']; ?>" height="150" width="150" /></p>
