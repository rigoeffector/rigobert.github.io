	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if(!isset($errMSG))
		{
			...
			if($stmt->execute()){
				...
				window.location.href='../pages/tables/secretaries.php';
				</script>
                <?php
			}
			else{
...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">Update Secretary details. <a class="btn btn-success" href="../pages/tables/secretaries.php"> all Secretaries </a>
...
<tr>
	<td><label class="control-label"> Img.</label></td>
		<td>
			<p><img src="../../Secretary/<?php echo $edit_row['user_image']; ?>" height="150" width="150" /></p>
