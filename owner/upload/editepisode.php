<?php
	...
	{
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare('SELECT * FROM episode WHERE ID =:uid');
	...
	{
		header("Location: ../pages/tables/episodes.php");
	}
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE episode
									     SET sdescription=:short,
									     	 title=:title,
										     description=:details,
										     Pic=:upic
								       WHERE ID=:uid');
			...
			if($stmt->execute()){
				...
				window.location.href='../pages/tables/episodes.php';
				</script>
                <?php
			}
			else{
...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">Update episode details. <a class="btn btn-success" href="../pages/tables/episodes.php"> all  episode </a>
   ...
   <tr>
    ...
    <tr>
     ...
     <tr>
        ...
        <td><textarea rows="10" class="form-control" type="text" name="user_job1" ><?php echo $edit_row['description']; ?></textarea>
        	</td>
    </tr>
...
<tr>
	<td><label class="control-label"> Img.</label></td>
		<td>
			<p><img src="../../episodeimages/<?php echo $edit_row['Pic']; ?>" height="150" width="150" /></p>
