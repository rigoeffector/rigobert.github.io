<?php
	...
	{
		header("Location: ../pages/tables/rvcupdates.php");
	}
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if(!isset($errMSG))
		{
			...
			if($stmt->execute()){
				...
				window.location.href='../pages/tables/rvcupdates.php';
				</script>
                <?php
			}
			else{
...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">Update RVC updates. <a class="btn btn-success" href="../pages/tables/rvcupdates.php"> all RVC updates</a>
...
<tr>
	<td><label class="control-label"> Img.</label></td>
		<td>
			<p><img src="../../updates/<?php echo $edit_row['Pic']; ?>" height="150" width="150" /></p>
