<?php
	...
	{
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare('SELECT * FROM event WHERE ID =:uid');
	...
	{
		header("Location: ../pages/tables/events.php");
	}
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE event
									     SET title=:title,
										     sdescription=:short,
										     description=:details,
										     Pic=:upic
			...
			if($stmt->execute()){
				...
				window.location.href='../pages/tables/events.php';
				</script>
                <?php
			}
			else{
...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">Update events details. <a class="btn btn-success" href="../pages/tables/events.php"> all RIYA news </a>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
     ...
     <tr>
        ...
        <td><textarea class="form-control" type="text" name="user_job1" ><?php echo $edit_row['description']; ?></textarea>
        	</td>
    </tr>
...
<tr>
	<td><label class="control-label"> Img.</label></td>
		<td>
			<p><img src="../../eventimages/<?php echo $edit_row['Pic']; ?>" height="150" width="150" /></p>
